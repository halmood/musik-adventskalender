/**
 * CHOR Adventskalender - Logic & Data (Edition: Modern Pop & Jazz V2)
 * Fokus: Groove, Pop-Technik, Performance & Chor-Wissen
 */

const musicRiddles = [
    {
        day: 1,
        q: "In der Klassik verpönt, im Pop erwünscht: Ich bin die Technik, mit der man hohe Töne kraftvoll und 'bruststimmig' schmettert.",
        a: "Belting (Belten)",
        e: "Klingt laut, ist aber Technik. **Pop-Chor Tipp:** Nicht schreien! Belting braucht extrem gute Körperanbindung."
    },
    {
        day: 2,
        q: "Die goldene Regel des Pop- & Gospel-Rhythmus: Auf welchen Zählzeiten wird geklatscht (im 4/4 Takt)?",
        a: "Auf 2 und 4 (Backbeat)",
        e: "Bitte nicht auf 1 und 3 klatschen! Das tötet den Groove. **Merke:** Friends don't let friends clap on 1 and 3."
    },
    {
        day: 3,
        q: "Ich bin das Gerät, das deine Stimme laut macht. Aber Achtung: Wenn du mich zuhälst oder in die Box zeigst, fange ich an zu pfeifen.",
        a: "Mikrofon (Feedback)",
    ...
    {
        day: 5,
        q: "Wenn der Chor 'Doo-dap-ba-da' singt, statt Text. Ursprünglich aus dem Jazz.",
        a: "Scat-Gesang",
        e: "Im Chor nutzen wir oft 'Silben-Grooves' als Rhythmus-Teppich für die Solisten."
    },
    {
        day: 6,
        q: "Ich sorge dafür, dass die Stimme 'scharf' und durchdringend klingt. Ohne mich geht man im Pop-Sound unter.",
        a: "Twang",
        e: "Twang verengt den Kehltrichter. Wer 'twangt', ist lauter bei weniger Luftverbrauch."
    },
    {
        day: 7,
    ...
    {
        day: 8,
        q: "Im Pop-Chor reicht uns oft ein Blatt Papier. Darauf stehen Text und Akkorde (z.B. Am7 - G - C).",
        a: "Lead Sheet",
        e: "Man muss wissen, wann man singt, denn Pausen stehen oft nicht drin."
    },
    {
        day: 9,
        q: "Ich bin der Teil im Song, der Spannung aufbaut, oft anders klingt und zum finalen Refrain hinführt.",
        a: "Die Bridge",
        e: "Die Bridge ist oft der emotionale Höhepunkt im Arrangement."
    },
    {
        day: 10,
        q: "Viele schnelle Töne auf einer einzigen Silbe singen (typisch Mariah Carey).",
        a: "Riffs & Runs (Melismen)",
        e: "Im Chor gilt: Alle müssen das Riff exakt gleich timen, sonst klingt es matschig."
    },
    {
        day: 11,
        q: "Wir singen nicht die Melodie, wir sind der Teppich darunter. Was ist unsere wichtigste Aufgabe?",
        a: "Blending (Sich mischen)",
        e: "**Regel:** Hörst du dich selbst lauter als deinen Nachbarn, bist du zu laut."
    },
    {
        day: 12,
        q: "Ein Meisterwerk von Queen. Es hat einen Opern-Teil ('Scaramouche!').",
        a: "Bohemian Rhapsody",
        e: "Freddie Mercury hat die Chor-Spuren so oft übereinandergelegt, bis die Bänder fast durchsichtig waren."
    },
    {
        day: 13,
        q: "Welche Intervalle bilden zusammen mit dem Grundton einen Dreiklang?",
        a: "Terz und Quinte",
        e: "Das Fundament der Harmonie. **Merke:** Kleine Terz = Moll-Dreiklang (traurig), große Terz = Dur-Dreiklang (fröhlich)."
    },
    {
        day: 14,
    ...
    {
        day: 15,
        q: "In welcher Gesangstechnik werden die 4 Modi 'Neutral', 'Curbing', 'Overdrive' und 'Edge' beschrieben?",
        a: "CVT (Complete Vocal Technique)",
        e: "Entwickelt von Cathrine Sadolin. Sie hilft, Sounds gesund zu erzeugen – vom hauchigen Pop bis zum rockigen Belting."
    },
    {
        day: 16,
        q: "Was muss beim Chorsingen besonders sauber sein?",
        a: "Die Intonation (Reinheit der Töne)",
        e: "Wenn es 'schwebt', stimmt die Intonation. **Was hilft:** Aktive Ohren, gute Zwerchfellstütze und viel Übung im Aufeinander-Hören."
    },
    {
        day: 17,
        q: "Was bedeutet es, wenn ein Song 'shuffelt'?",
        a: "Die Achtel sind ungleich (Lang-Kurz)",
    ...
    {
        day: 19,
        q: "Eine Übung, bei der die Lippen flattern wie bei einem Pferd.",
        a: "Lip Trills",
    ...
    {
        day: 21,
        q: "Wie nennt man es, wenn der Chorleiter spontan Zeichen gibt für Loops und Improvisation?",
        a: "Circle Singing",
        e: "Musik entsteht im Moment. Trainiert das Ohr extrem."
    },
    {
        day: 22,
        q: "Zwei Songs werden ineinander gemischt.",
        a: "Mashup",
        e: "Funktioniert super mit den '4 Chords of Pop'."
    },
    {
        day: 23,
        q: "Was sollte man auf der Bühne *nicht* tun?",
        a: "In Noten blättern oder quatschen",
...
function openRiddle(day) {
    ...
    // BILD LADEN: Sucht nach images/tag1.png ...
    ...
    // Falls Bild doch existiert (beim erneuten Öffnen), wieder einblenden
